...
var loginData = require('../public/data/login/login.json');
var signUpData = require('../public/data/register/register.json');
...
router.get('/signup', function(req, res, next) {
  res.render('signup.hbs', { cart, signUpData:signUpData });
});
